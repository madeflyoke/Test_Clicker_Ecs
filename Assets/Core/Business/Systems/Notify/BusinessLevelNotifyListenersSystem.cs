...
{
    public class BusinessLevelNotifyListenersSystem : IEcsRunSystem, IEcsInitSystem
    {
        private EcsFilterInject<Inc<ValueChangedListenerComponent<LevelComponent, int>, LevelComponent>>
            _listenersFilter;
        
        private EcsPoolInject<NotifyFullRefreshComponent> _fullRefreshPool;
        private EcsPoolInject<NotifyValueChangedComponent<LevelComponent>> _notifiersPool;
