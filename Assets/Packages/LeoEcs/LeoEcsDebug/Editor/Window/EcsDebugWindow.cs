...
using Packages.LeoEcs.LeoEcsDebug.Editor.Window.Entity;
using Packages.LeoEcs.LeoEcsDebug.Editor.Window.Filter;
using Packages.LeoEcs.LeoEcsDebug.Editor.Window.Layout;
   ...
   public class EcsDebugWindow : BaseEcsDebugWindow {
      ...
      private void UnselectEntity(int e) {
         try {
            ...
            UnityEngine.Debug.Log($"Error: {e} -> {exception}");
         }
      }
